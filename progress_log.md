Week 1:Foudation and Planning
Date: 2026-03-03
Task: Use the Github repository to defined the research framework.
Outcome: 1. Set the repository structure
         2. Set the table of contents based on the assignment guideline


Reviewed core materials: Hagendorff (2020), Australia's AI Ethics Principles, and the Guidance for AI Adoption.
...
* Drafting Milestone: >   * Successfully completed the first draft of the Introduction (approx. 510 words), satisfying the Week 2-3 requirement to establish the background, methodology, and scope.Developed an extended structural outline for the Body Paragraphs (Sections 2-5, approx. 615 words), incorporating empirical data plans (Bloomberg) and technical case studies (LAION-5B).
* Next Steps (Week 4): Conduct further systematic research to expand the body sections and synthesize arguments to reach the 1,800-2,500 word milestone.
